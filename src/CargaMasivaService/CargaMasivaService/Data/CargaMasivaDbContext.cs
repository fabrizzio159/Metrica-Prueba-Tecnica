...
namespace CargaMasivaService.Data;
...
public class CargaMasivaDbContext : DbContext
{
    ...
    public DbSet<AuditoriaFallo> AuditoriaFallos => Set<AuditoriaFallo>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AuditoriaFallo>(entity =>
        {
            entity.ToTable("AuditoriaFallo");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.CodigoProducto).HasMaxLength(50);
            entity.Property(e => e.MotivoRechazo).HasMaxLength(100).IsRequired();
            entity.Property(e => e.FechaRegistro).HasDefaultValueSql("GETDATE()");
            entity.HasOne(e => e.CargaArchivo)
                  .WithMany()
                  .HasForeignKey(e => e.CargaArchivoId)
